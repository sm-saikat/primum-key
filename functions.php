 ...
 */
 ...
 function premium_register_styles(){
	wp_enqueue_style( 'premium_main_style', get_template_directory_uri() . '/assets/style.css', null, '1.0', 'all' );

 }
 add_action('wp_enqueue_scripts', 'premium_register_styles');